...
export default function AddDocument1Marks() {
  ...
  const Submit = (e) => {
    ...
    const doc1Marks = sumRubik01 + sumRubik02 + sumRubik03;
    const studentData = {
      regNumber,
      doc1Marks,
    };
    axios
      .post("http://localhost:3000/addDocument1Marks", studentData)
